...
- **Unit tests**: `go test -race ./provider/...` (uses httptest mocks)
- **Integration tests**: `go test -tags=integration ./test/integration/...` (needs VyOS VM)
- **VyOS VM**: `test/vm/run.sh start` (QEMU with cloud-init)
